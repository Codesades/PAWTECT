// assets/js/data.js (ĐÃ CẬP NHẬT VỚI 'cid')

const appData = {
    posts: [
        {
            cid: 'case202', // <-- ID SẠCH, DUY NHẤT
            id: 'CASE #202',
            userName: 'Chi Lê',
            ...
            imagePet: 'assets/images/Anh_Cho.jpg',
            status: 'unhandled',
            distance: 2.5
        },
        {
            cid: 'case101', // <-- ID SẠCH, DUY NHẤT
            id: 'CASE #101',
            userName: 'An Nguyễn',
            ...
            imagePet: 'assets/images/Anh_Meo.jpg',
            status: 'pending',
            distance: 1.0
        },
        {
            cid: 'case102', // <-- ID SẠCH, DUY NHẤT
            id: 'CASE #102',
            userName: 'Bình Trần',
            ...
            imagePet: 'assets/images/be-gau.png',
            status: 'pending',
            distance: 5.2
        },
        {
            cid: 'case201', // <-- ID SẠCH, DUY NHẤT
            id: 'CASE #201',
            userName: 'An Nguyễn',
            ...
            imagePet: 'assets/images/be-ruoi.png',
            status: 'unhandled',
            distance: 10.8
        },
        {
            cid: 'case301', // <-- ID SẠCH, DUY NHẤT
            id: 'CASE #301',
            userName: 'Bình Trần',
            ...
            imagePet: 'assets/images/be-yaua.png',
            status: 'handled',
            distance: 3.1
        }
    ]
