document.addEventListener('DOMContentLoaded', () => {
    ...
    if (reportForm) {
        reportForm.addEventListener('submit', function(event) {
            ...
            // ==========================================================
            // THAY ĐỔI Ở ĐÂY: Chuyển hướng thay vì hiển thị alert
            // ==========================================================
            
            // Giả lập việc gửi form thành công và chuyển hướng
            // Thay vì: alert('Báo cáo đã được gửi thành công!...');
            
            // Chuyển người dùng đến trang báo cáo thành công
            window.location.href = 'report-complete.html';
        });
    }
